      ...
      <div class="contact-form__container">
        ...
        <div class="contact-form__input-row contact-form__input-row--fullname">
          <div class="contact-form__input-wrapper contact-form__input-wrapper--salutation">
            <select name="salutation" class="contact-form__input contact-form__input--select" required>
          ...
          <div class="contact-form__input-wrapper contact-form__input-wrapper--firstname">
            <input type="text" name="firstname" class="contact-form__input contact-form__input--text" placeholder="Given name" required>
          </div>
          <div class="contact-form__input-wrapper contact-form__input-wrapper--lastname">
            <input type="text" name="lastname"class="contact-form__input contact-form__input--text" placeholder="Family name" required>
          </div>
        </div>
        <div class="contact-form__input-row contact-form__input-row--contact">
          <div class="contact-form__input-wrapper contact-form__input-wrapper--email">
            <input type="email" name="email" class="contact-form__input contact-form__input--email" placeholder="Email" required>
          </div>
          <div class="contact-form__input-wrapper contact-form__input-wrapper--country-code">
            <select name="country-code" class="contact-form__input contact-form__input--select" required>
        ...
        <div class="contact-form__input-row contact-form__input-row--branch">
          <div class="contact-form__input-wrapper contact-form__input-wrapper--branch-country">
            <select name="branch-country" class="contact-form__input contact-form__input--select" required>
          ...
          <div class="contact-form__input-wrapper contact-form__input-wrapper--branch">
            <input type="text" name="branch" class="contact-form__input contact-form__input--text" placeholder="Preferred Boutique" required>
          </div>
        </div>
        <div class="contact-form__input-row contact-form__input-row--message">
          <div class="contact-form__input-wrapper contact-form__input-wrapper--message">
            <textarea name="message" row="4" class="contact-form__input contact-form__input--textarea" required>I would like to enquire about the availability of this model.</textarea>
          </div>
        </div>
